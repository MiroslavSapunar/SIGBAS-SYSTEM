import { Internship } from "@/models/collections/intership";
...
const Row: React.FC<RowProps> = ({ internship }) =>
    <>
        <tr className="odd:bg-gray-50">
            <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                {internship.monthlyAmount}
            </td>
...
const DashboardLanding: React.FC<DashboardLandingProps> = ({ internships }) =>
